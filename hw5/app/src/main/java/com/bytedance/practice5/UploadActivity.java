...
public class UploadActivity extends AppCompatActivity {
    ...
    private void submit() {
        ...
        Log.d("summitkk","after multipartbody");

        Call<UploadResponse> call = api.submitMessage(Constants.STUDENT_ID,"",namePart,toPart,contentPart,coverPart,Constants.token);

        Log.d("summitkk","after call uploadresponse");

        try{
            Log.d("summitkk","in try");
            call.enqueue(new Callback<UploadResponse>() {
                ...
                public void onResponse(Call<UploadResponse> call, Response<UploadResponse> response){
                    ...
                    Log.d("summitkk","in override onResponse");
            ...
            Response<UploadResponse> response =
                    call.enqueue(new Callback<UploadResponse>);
            Log.d("summitkk","response in try");
            if(response.isSuccessful()){
                Log.d("summitkk","is successful");
                finish();
            }else{
            ...
            */
            ...
            e.printStackTrace();
            Toast.makeText(this, "提交失败 in catch", Toast.LENGTH_SHORT).show();
        }
    }
